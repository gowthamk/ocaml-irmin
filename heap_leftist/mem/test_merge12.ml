...
let _ =
  ...
  let q2 =  original |> H.insert (Int64.of_int 5) |> H.delete_min |> H.insert (Int64.of_int 2)   in 
  let q1 = original |> H.delete_min |> H.insert (Int64.of_int 2) in 
